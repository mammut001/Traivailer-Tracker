...
const WorkLogList = () => {
    ...
    const SecondRoute = () => (
      <ScrollView style={styles.routeContainer} contentContainerStyle={{ flexGrow: 1 }}>
          {Array(20).fill(31231).map((_, index) => (
...
const styles = StyleSheet.create({
    ...
    routeContainer: {
        flex: 1,
        backgroundColor: '#FFC0CB', // Ensure the background color fills the space
    },
    rowFront: {
        alignItems: 'center',
        backgroundColor: '#CCC',
